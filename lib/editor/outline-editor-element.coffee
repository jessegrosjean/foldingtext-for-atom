...
atom.commands.add 'ft-outline-editor', EventRegistery.stopEventPropagationAndGroupUndo(
  ...
  'core:backspace': -> @editor.deleteCharacterBackward()
  'editor:delete-to-beginning-of-word': -> @editor.deleteWordBackward()
  'editor:delete-to-beginning-of-line': -> @editor.deleteLineBoundaryBackward()
  'editor:delete-to-end-of-paragraph': -> @editor.deleteParagraphBoundaryForward()
  'core:delete': -> @editor.deleteCharacterForward()
  ...
  'outline-editor::delete-item': -> @editor.deleteItemsBackward()
  'outline-editor::move-item-up': -> @editor.moveItemsUp()
  'outline-editor::move-item-down': -> @editor.moveItemsDown()
  'outline-editor:dupliate-items': -> @editor.duplicateItems()
